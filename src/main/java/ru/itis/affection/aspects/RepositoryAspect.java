package ru.itis.affection.aspects;
...
public class RepositoryAspect {
    ...
    @Around(value = "ru.itis.affection.aspects.RepositoryAspect.repositoryPoint()", argNames = "pjp")
    ...
    @AfterThrowing(value = "ru.itis.affection.aspects.RepositoryAspect.repositoryPoint()", throwing = "ex")
